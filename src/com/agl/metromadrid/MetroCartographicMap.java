...
public class MetroCartographicMap extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (l.toString().equals("es_ES")){
        	map_pic.loadUrl("file:///android_asset/plano_c_esp.gif");
        }
        else{
        	map_pic.loadUrl("file:///android_asset/plano_c_eng.gif");
        }
	}
